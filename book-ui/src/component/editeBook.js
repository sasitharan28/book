  ...
  constructor(props){
    ...
    getBookDetails=(bookId)=>{
        ...
        .then(res=>{
          ...
          console.log(res.data);
            this.setState({
                titleVal:res.data.title,
                authorVal:res.data.author,
                coverPhotoUrlVal:res.data.coverPhotoURL,
                isbnNumVal:res.data.isbnNumber,
                priceVal:res.data.price,
                languageVal:res.data.language,
                genreVal:res.data.genre,
            })
        })
    }
